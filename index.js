...
searchBtn.addEventListener('click', async function(e){
    ...
    document.getElementById('results').innerHTML = await getResultsHtml(filmIdArray)
})
...
async function getFilmIdArray(userInput){
    const res = await fetch(`https://www.omdbapi.com/?s=${userInput}&apikey=17073252`)
                ...
                <div class="filmData-desc">
                    ...
                    <div class="info">
                        ...
                        <button
                            ...
                            id="${filmData.imdbID}"
                            onclick="addToWatchlist(${filmData.imdbID})">
                            Watchlist
                        </button>
                    </div>
                    <div class="synopsis">
